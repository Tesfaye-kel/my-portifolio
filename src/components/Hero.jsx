      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              {hero?.description || 'Your hero description goes here...'}
            </motion.p>
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-block bg-primary text-navy px-8 py-4 rounded-md text-lg font-mono font-semibold hover:bg-primary/90 transition-colors duration-300"
            >
              Get in Touch
            </motion.a>
          </motion.div>
